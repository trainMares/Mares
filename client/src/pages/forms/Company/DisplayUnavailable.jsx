...
function OpportunityCard({ OpportunityID, OpportunityName, TrainingType, TrainingDuration, City, imageURL, numberOfTrainees }) {
    ...
    if (numberOfTrainees> OppnumberOfTrainees ||  currentDate>startDate )//غيرمتاحة
...
export default function DisplayUnavailable() {
    const opp = [
        ...
        { OpportunityID: '003', OpportunityName: 'مطور ويب', TrainingType: 'حضوري', TrainingDuration: '4 أشهر', City: 'الدمام', imageURL: '/images/web_developer.jpg' , numberOfTrainees:'21'},
